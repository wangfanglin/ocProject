...
function SetUserCertList(strListID, certType,strServerSignedData,strServerRan,strServerCert)
{
  $_$strServerSignedData = strServerSignedData;
  $_$strServerRan = strServerRan;
  $_$strServerCert = strServerCert;
  // console.log(strListID, certType,$_$strServerSignedData, $_$strServerRan,$_$strServerCert)
...
function $pushAllDropListBox(certUserListObj)
{
    ...
    while (true) {
        ...
        // $_$userList.push({name:strName,id:strCertID});
        if ($_$hardCertListID != "") {
...
function CreateWebSocketObject() {
    ...
    o.ws_port_array = ["21051/xtxapp", "21061/xtxapp", "4044","5044", "6044", "7044", "8044"];
    o.ws_port_use = 0;
    o.ws_obj = null;
    o.ws_heartbeat_id = 0;
    ...
    o.callMethod = function(strMethodName, cb, ctx, returnType, argsArray) {
      // console.log(strMethodName, cb, ctx, returnType, argsArray)
        o.ws_queue_id++;
        if (typeof(cb) == 'function'){
...
function $loginSignRandomCallBack(retObj)
{
    ...
    objForm.strRandom.value = $_$strServerRan;
...
function $loginVerifyServerSignatureCallBack(retObj)
{
    ...
    SignedData(strCertID, $_$strServerRan, $loginSignRandomCallBack, retObj.ctx);
}
function $loginCheckCertValidNotAfter(retObj)
{
  ...
  var notAfterDate = GetDateNotAfter(retObj.retVal);
    ...
    VerifySignedData($_$strServerCert, $_$strServerRan, $_$strServerSignedData,
...
export  {init, destroy, SetUserCertList, Login}
