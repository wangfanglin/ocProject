define(["app/widgets/panel/app-panel","app/core/app-options"],function(Panel,Options){
		$.fn._propAttr = $.fn.prop || $.fn.attr;
		var parseValue=function(property, value, parent, delta){
			delta = delta || 0;
 ...
 var _1 = 0;
			...
			$(_50).children("thead").each(function() {
				...
				$(this).find("tr").each(function() {
					...
					$(this).find("th").each(function() {
						var th = $(this);
						var col = $.extend({}, $.fn.parseOptions(this, [
												"field", "align", "halign",
												"order", "width", {
													sortable : "boolean",
													checkbox : "boolean",
		...
		function _9f() {
			...
			$.map(_a9, function(_aa) {
						...
						if (String(col.width || "").indexOf("%") >= 0) {
							var _ab = parseValue("width", col.width,
	...
	function _13a(_13b, _13c, _13d) {
		...
		if (!_13d) {
			...
			tr.find("div.datagrid-editable").each(function() {
						...
						var ed = $.data(this, "datagrid.editor");
						var _144 = ed.actions.getValue(ed.target,row,_143);
						if (row[_143] != _144) {
							row[_143] = _144;
							_141 = true;
							_142[_143] = _144;
		...
		function _193(name) {
			...
			return {
				init : function(_195, _196) {
					var _197 = $("<input type=\"text\" class=\"datagrid-editable-input\" width=\"100%\">")
							.appendTo(_195);
					if (_197[name] && name != "text") {
						var t=_197[name](_196);
						return _197;
					} else {
						return _197;
					}
	...
	var _19e = $.extend({},
			_190(["text", "textbox", "number", "numberspinner", "combobox",
					"combotree", "comboztree", "combogrid", "datebox", "datetimebox",
	...
	$.fn.datagrid.parseOptions = function(_1e4) {
		var t = $(_1e4);
		return $.extend({}, Panel.parseOptions(_1e4), t
				...
				if (col) {
					...
					if (col.checkbox) {
						...
						if (col.formatter) {
							...
							if (_1fb&&_1fb.editor&&_1fb.editor.type=="button"){
								if (typeof(_1fe)=="object"){
	...
	$.fn.datagrid.defaults = $.extend({}, Options.appDefaults.Panel, {
